...
import com.isem.mvc.service.PdvService;
...
public class PdvController {
	...
	public Page<Pdv> getAll(@RequestParam(value = "str") int strana, 
	...
	public Pdv findById(@RequestParam("id") Long id){
		return service.findById(id);
	}		

	@RequestMapping(value="/dodaj", method=RequestMethod.POST)
	public Pdv add(@RequestBody Pdv obj) {
