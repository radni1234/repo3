...
import com.isem.mvc.service.RezervoarService;

@RestController
@RequestMapping("/rezervoar")
public class RezervoarController {
	@Autowired
	private RezervoarService service;

	@RequestMapping(value="/sve", method=RequestMethod.GET)
	public List<Rezervoar> getAll() {
		return service.findAll();
	}

	@RequestMapping(value="/sve", params = {"str", "vel"}, method=RequestMethod.GET)
	public Page<Rezervoar> getAll(@RequestParam(value = "str") int strana, 
	...
	public Rezervoar add(@RequestBody Rezervoar obj) {
