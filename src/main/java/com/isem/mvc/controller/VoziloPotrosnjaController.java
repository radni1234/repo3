...
public class VoziloPotrosnjaController {
	@Autowired
	private VoziloPotrosnjaService service;

	@RequestMapping(value="/sve", method=RequestMethod.GET)
	public List<VoziloPotrosnja> getAll() {
		return service.findAll();
	}

	@RequestMapping(value="/sve", params = {"str", "vel"}, method=RequestMethod.GET)
	public Page<VoziloPotrosnja> getAll(@RequestParam(value = "str") int strana, 
	...
	public VoziloPotrosnja findById(@RequestParam("id") Long id){
		return service.findById(id);
	}		

	@RequestMapping(value="/dodaj", method=RequestMethod.POST)
	public VoziloPotrosnja add(@RequestBody VoziloPotrosnja obj) {
