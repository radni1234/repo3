...
import com.isem.mvc.service.GrupaService;
...
public class GrupaController {
	...
	public Page<Grupa> getAll(@RequestParam(value = "str") int strana, 
	...
	public Grupa findById(@RequestParam("id") Long id){
		return service.findById(id);
	}		

	@RequestMapping(value="/dodaj", method=RequestMethod.POST)
	public Grupa add(@RequestBody Grupa obj) {
