...
@RestController
@RequestMapping("/stub_tip")
public class StubTipController {
	@Autowired
	private StubTipService service;

	@RequestMapping(value="/sve", method=RequestMethod.GET)
	public List<StubTip> getAll() {
		return service.findAll();
	}

	@RequestMapping(value="/sve", params = {"str", "vel"}, method=RequestMethod.GET)
	public Page<StubTip> getAll(@RequestParam(value = "str") int strana, 
