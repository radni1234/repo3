...
import com.isem.mvc.service.PodgrupaService;

@RestController
@RequestMapping("/podgrupa")
public class PodgrupaController {
	@Autowired
	private PodgrupaService service;
	
	@RequestMapping(value="/sve", method=RequestMethod.GET)
	public List<Podgrupa> getAll() {
		return service.findAll();
	}

	@RequestMapping(value="/sve", params = {"str", "vel"}, method=RequestMethod.GET)
	public Page<Podgrupa> getAll(@RequestParam(value = "str") int strana, 
	...
	public Podgrupa add(@RequestBody Podgrupa obj) {
