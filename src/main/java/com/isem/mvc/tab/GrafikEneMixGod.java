...
@NamedStoredProcedureQuery(
        name="graf_ene_mix_god",
        procedureName="graf_ene_mix_god",
        resultClasses = { GrafikEneMixGod.class },
        parameters={
...
public class GrafikEneMixGod {
	...
	public GrafikEneMixGod(String energent,String godina, 
