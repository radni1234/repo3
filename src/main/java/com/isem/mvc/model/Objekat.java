...
public class Objekat {
	...
	public String toString() {
		return "Objekat [id=" + id + ", naziv=" + naziv + ", version=" + version + ", mesto=" + mesto + ", adresa="
				+ adresa + ", podgrupa=" + podgrupa + ", godIzgr=" + godIzgr + ", projektanFirma=" + projektanFirma
				...
				+ ", opPopunjenostKap=" + opPopunjenostKap + ", opBrDnevKor=" + opBrDnevKor + ", lon=" + lon + ", lat="
				+ lat + ", nacinFinansiranja=" + nacinFinansiranja + ", trendTolerancija=" + trendTolerancija
				+ ", alarmTrend=" + alarmTrend + ", alarmTrendStart=" + alarmTrendStart + "]";
	}
